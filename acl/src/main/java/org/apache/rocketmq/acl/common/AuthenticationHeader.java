...
public class AuthenticationHeader {
    ...
    AuthenticationHeader(final String remoteAddress, final String namespace, final String authorization, final String datetime, final String sessionToken, final String requestId, final String language, final String clientVersion, final String protocol, final int requestCode) {
    ...
    public static class MetadataHeaderBuilder {
        ...
        public AuthenticationHeader build() {
            return new AuthenticationHeader(this.remoteAddress, this.namespace, this.authorization, this.datetime, this.sessionToken, this.requestId, this.language, this.clientVersion, this.protocol, this.requestCode);
        }
    }
