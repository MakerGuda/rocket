...
public class DLedgerRoleChangeHandler implements DLedgerLeaderElector.RoleChangeHandler {
    ...
    public DLedgerRoleChangeHandler(BrokerController brokerController, DefaultMessageStore messageStore) {
        ...
        this.executorService = ThreadUtils.newSingleThreadExecutor(new ThreadFactoryImpl("DLegerRoleChangeHandler_", brokerController.getBrokerIdentity()));
    }
    ...
    public void changeToSlave(int brokerId) {
        ...
        this.brokerController.getBrokerConfig().setBrokerId(brokerId == 0 ? 1 : brokerId);
    ...
    public void changeToMaster(BrokerRole role) {
        ...
        this.brokerController.getBrokerConfig().setBrokerId(0);
