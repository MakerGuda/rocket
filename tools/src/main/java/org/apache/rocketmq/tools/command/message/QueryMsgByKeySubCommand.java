...
public class QueryMsgByKeySubCommand implements SubCommand {
    ...
    private void queryByKey(final DefaultMQAdminExt admin, final String topic, final String key, int maxNum, long begin, long end) throws MQClientException, InterruptedException {
        admin.start();
