...
public class QueryMsgTraceByIdSubCommand implements SubCommand {
    ...
    private void queryTraceByMsgId(final DefaultMQAdminExt admin, String traceTopic, String msgId, int maxNum, long begin, long end) throws MQClientException, InterruptedException {
        admin.start();
